...
ESTAT <- ESTAT[, c("na_item","geo","time","values")]
...
write.csv(table.summary, "Summary.csv")
...
* <span style="background-color: lightblue">Cells in lightblue</span> indicate that, compared to the reference organisation, the concerned organisation is missing at least one observation for the country in question.
